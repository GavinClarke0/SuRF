...
namespace surf {
    ...
    public:
        ...
        LabelVector(const std::vector<std::vector<label_t> > &labels_per_level,
            ...
            labels_ = std::make_unique<label_t[]>(alloc_bytes);
        ...
        void serialize(char *&dst) const {
            ...
            memcpy(dst, labels_.get(), num_bytes_);
            dst += num_bytes_;
            align(dst);
        }
        ...
        static LabelVector *deSerialize(char *&src) {
            ...
            lv->labels_ = std::make_unique<label_t[]>(lv->num_bytes_);
            memcpy(lv->labels_.get(), src, lv->num_bytes_);
            src += lv->num_bytes_;
