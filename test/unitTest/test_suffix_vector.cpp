...
// DEPRECATED
    namespace suffixvectortest {
        ...
        TEST_F (SuffixVectorUnitTest, buildNoneTest) {
            ...
            suffixes_ = new BitvectorSuffix(kNone, builder_->getSuffixes());
        }
        ...
        TEST_F (SuffixVectorUnitTest, buildHashTest) {
            ...
            builder_->build(words);
            suffixes_ = new BitvectorSuffix(kHash, builder_->getSuffixes());
        }
        ...
        TEST_F (SuffixVectorUnitTest, buildRealTest) {
            ...
            builder_->build(words);
            suffixes_ = new BitvectorSuffix(kReal, builder_->getSuffixes());
        }
